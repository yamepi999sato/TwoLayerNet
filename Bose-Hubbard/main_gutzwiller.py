...
axn.plot(np.arange(1, params.M+1), nnn, label="<n>", color="red")
axn.set_title("<n>")
axn.set_xlabel("site")
axn.set_ylabel("<n>")
...
axK.plot(is_K, np.array(Ks_K), label="step1 (K-maximizing)", color="hotpink")
axK.plot(is_E, np.array(Ks_E), label="step2 (E-minimizing)", color="red")
...
axE.plot(np.arange(params.ITER_NUM_K + params.ITER_NUM_E), (data["E"] * np.ones(params.ITER_NUM_K + params.ITER_NUM_E)), 
         label="Gutzwiller", color="dimgray", ls="-.")
axE.plot(is_K, (np.array(Hs_K)/params.M ), label="step1 (K-maximizing)", color="hotpink")
axE.plot(is_E, (np.array(Hs_E)/params.M ), label="step2 (E-minimizing)", color="red")
...
axeE.plot(is_K, np.abs((np.array(Hs_K)/params.M ) - data["E"]), label="step1 (K-maximizing)", color="hotpink")
axeE.plot(is_E, np.abs((np.array(Hs_E)/params.M ) - data["E"]), label="step2 (E-minimizing)", color="red")
